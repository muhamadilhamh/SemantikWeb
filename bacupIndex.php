    ...
    $data = sparql_get(
      ...
      { 
          ?id d:namaMatkul ?Matkul ;
              ...
              d:semester ?semester;
              FILTER (regex(?jumlahSks, '$test') || regex(?Matkul, '$test') || regex(?jenisMatkul,  '$test') || regex(?deskripsi,  '$test') ||  regex(?dosenPengajar, '$test') )
      }
            "
    );
  } else {
        ...
        <div class="form-group has-search">
          <form action="" method="post" id="nameform">
            <div class="input-group">
              ...
              <input type="text" name="search-matakuliah" class="form-control form-control-lg " placeholder="Cari Data">
